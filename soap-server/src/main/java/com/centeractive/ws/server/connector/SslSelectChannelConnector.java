 ...
 */
package com.centeractive.ws.server.connector;

import org.mortbay.io.Buffer;
import org.mortbay.io.Connection;
import org.mortbay.io.EndPoint;
import org.mortbay.io.bio.SocketEndPoint;
import org.mortbay.io.nio.*;
...
public class SslSelectChannelConnector extends org.mortbay.jetty.nio.SelectChannelConnector
{
    ...
    {
        _password= password;//Password.getPassword(PASSWORD_PROPERTY, password, null);
    }

    /* ------------------------------------------------------------ */
    public void setTrustPassword(String password)
    {
        _trustPassword=password;//Password.getPassword(PASSWORD_PROPERTY,password,null);
    }

    /* ------------------------------------------------------------ */
    public void setKeyPassword(String password)
    {
        _keyPassword=password;//Password.getPassword(KEYPASSWORD_PROPERTY,password,null);
    }
